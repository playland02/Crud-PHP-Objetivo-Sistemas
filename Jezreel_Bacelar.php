...
use Devjunior\Desafioobj\Models\ClienteDAO;
...
if (isset($_POST['nome'])) {
    if (isset($_POST['observacao'])) {
        if (isset($_POST['telefone'])) {
            ...
            $cliente->__set('observacao', $_POST['observacao']);
...
//Verifica se tem dados parametros de ir na url
if (isset($_GET['delete'])) {
    ClienteDAO::delete($_GET['delete']);
}
            ...
            <div class="col-lg-7 mx-auto">
                ...
                <form method="post" action="index.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="nome" type="text" class="form-control" id="" placeholder="Fulano da Silva Santos">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Telefone:</label>
                        <input name="telefone" type="number" class="form-control" id="" placeholder="(71) 3241-3010">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Observação:</label>
                        <textarea name="observacao" class="form-control" id="" placeholder="Alguma Observação Aqui !" rows="3"></textarea>
                    </div>
        ...
        <div class="album py-5 bg-body-tertiary">
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    <?php $dados = ClienteDAO::read();

                    foreach ($dados as $cliente) {
                        $href_delete = $cliente['id_cliente'];
